...
class MitmProxyHandler(http_server.BaseHTTPRequestHandler):
    ...
    def _connect_to_host(self):
        ...
        self._proxy_sock.settimeout(WarcProxy.timeout)
    ...
    def _transition_to_ssl(self):
        ...
        self.request = self.connection = ssl.wrap_socket(self.connection,
                server_side=True, certfile=self.server.ca[hostname])
...
def _build_arg_parser(prog=os.path.basename(sys.argv[0])):
    ...
    arg_parser.add_argument('--timeout', dest='timeout', type=int, default=None,
...
def main(argv=sys.argv):
    ...
    if args.timeout:
        WarcProxy.timeout = args.timeout
